...
const { shippingQueue } = require("./queues");
...
const startWorkers = async () => {
  ...
  const shippingWorker = new Worker("shipping", jobHandler, redisConfig);
  const shippingScheduler = new QueueScheduler("shipping", redisConfig);
  workers.push({ worker: shippingWorker, scheduler: shippingScheduler });
